...
require('header.php')
?>
<div class="filter-container bg-darklight-100" style="position: sticky;top: var(--header-height); z-index:9999;border-bottom: 1px solid var(--blue-200);margin-bottom: 20px;">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-xxl-6 col-md-6">
                <div class="input-group flex-nowrap align-items-center">
                    ...
                    <input type="text" name="daterange" class="form-control fs-14 text-blue-400 rounded-0">
                </div>
            </div>
            <div class="col-lg-3 col-xxl-3 col-md-6">
                <div class="input-group flex-nowrap align-items-center">
